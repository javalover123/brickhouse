...
CREATE TEMPORARY FUNCTION tagged_sessionize AS 'brickhouse.udf.collect.TaggedSessionizeUDF';
...
CREATE TEMPORARY FUNCTION firstOfPrevMonth AS 'brickhouse.udf.date.FirstOfPreviousMonthUDF';
