...
public class TaggedSessionizeWithString extends UDF {
    ...
    private static class TaggedSessionInfo {
        ...
        public TaggedSessionInfo(String userId) {
            this.userId = userId;
    ...
    public String evaluate(String uid, String ua, long ts) {
     ...
     * @return
     */
    public String evaluate(String uid, String ua, long ts, int tolerance) {
